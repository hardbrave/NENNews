...
@interface NENTopNewsContentViewCell ()
@property (weak, nonatomic) IBOutlet UIImageView *imageIcon;
@property (weak, nonatomic) IBOutlet UILabel *titleLabel;

@end

@implementation NENTopNewsContentViewCell
#pragma mark - 实例化方法
+ (instancetype)cell
{
    return [[[NSBundle mainBundle] loadNibNamed:@"NENTopNewsContentViewCell" owner:nil options:nil] firstObject];
}
